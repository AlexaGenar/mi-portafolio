        ...
        <div className="mt-12 lg:mt-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            ...
            <motion.div
              ...
              className="relative rounded-2xl overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl group"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-pink-200 to-purple-200 dark:from-pink-300 dark:to-purple-400 transform -rotate-6 z-0" />

              <Image
                src="/gene.jpg"
                alt="Foto de Génesis Gómez"
                width={450}
                height={100}
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -right-6 w-24 h-24 bg-yellow-200 dark:bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 z-10"
              />
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{ delay: 1.1, type: "spring" }}
                className="absolute -top-6 -left-6 w-24 h-24 bg-blue-200 dark:bg-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 z-10"
              />
            </motion.div>
          ...
          >
            ...
            <motion.div
              ...
              className="mt-12 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-50 dark:border-gray-700 text-center sm:text-left"
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                Estas actividades me ayudan a mantener una perspectiva fresca y creativa que llevo a mis proyectos profesionales.
              </p>
            </motion.div>
          </motion.div>
        </div>
