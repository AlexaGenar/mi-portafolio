        ...
        <div className="mt-12 lg:mt-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            ...
            <motion.div
              ...
              className="mt-12 bg-white p-6 rounded-lg shadow-md border border-gray-50"
            >
              <h3 className="text-xl font-bold text-gray-900 mb-4">Mi Filosofía de Trabajo</h3>
              ...
              <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Fuera del Trabajo</h3>
              <p className="text-gray-600">
                En mi tiempo libre disfruto de la fotografía, los viajes y la lectura de libros sobre 
                diseño y tecnología. Estas actividades me ayudan a mantener una perspectiva fresca 
